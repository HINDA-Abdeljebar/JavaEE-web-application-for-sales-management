...
<body>
  ...
  <header>
    ...
    <form id="checkout-form" style=" margin: 10px 10px 10px 10px">
        <table id="cart-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="Dec_cart(<%=c.getId()%>)" class="quantity-btn minus-btn">
                            <i class="fas fa-minus"></i>
                        </button>
                        <input name="quantity" value="<%=c.getQuantity()%>" min="1" style="width: 50px;">
                        <button onclick="Inc_cart(<%=c.getId()%>)" class="quantity-btn plus-btn">
        ...
        <br>
        <p>
            <span style="font-size:120%;position: absolute; left: 65%; display: inline; font-weight: bold; font-family: sans-serif; color: red; ;">Total:</span>
            <span style="font-size:120%;position: absolute; left: 76%; font-family: sans-serif; font-weight: bold;color:green;"><%=total%> $</span>
        </p>
    </form>
