...
href="${pageContext.request.contextPath}/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/vente-

system/css/style.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/vente-

system/css/nav_style.css">
    <link rel="icon" href="${pageContext.request.contextPath}/vente-

system/images/rayban_logo.png" /> 
</head>
<body>
    <header>
...
src="${pageContext.request.contextPath}/vente-system/images/rayban_logo.png" alt="Logo"></a>
...
class="search-input">
        ...
        <nav class="navbar">
            ...
            <ul>
                <li><a href="${pageContext.request.contextPath}/vente-

system/articles.jsp">Home</a></li>
                <li>
                    <a href="/Vente_management/vente-system/cart.jsp">Cart
                        <span style="color:white;background-color: rgb(144, 238, 144); border-radius: 5px; 

position: relative; top: -5px; font-size: 0.7em; padding: 2px 2.5px;">
                            <%=number%>
                        </span>
                    </a>
                </li>
...
system/orders.jsp">Orders</a></li>
                        <li><a href="${pageContext.request.contextPath}/user-system/reset-

password.jsp">Change password</a></li>
<%        if (loggedInUser.isRole() == true) { %>
        ...
        <h2 style="font-size: 80%; ">Search Result for " <%= query %> "</h2>
        ...
        <div class="all-products">
            ...
            <div class="product" style="height:500px; width:300px">
                ...
                <div class="product-info">
                    ...
                    <p class="product-price" style="color:grey; font-size: 50%">Quantity 

left: <%=article.getQuantity()%></p>
                    <a  class="addToCartButton" href="toCart.action?id=<%=article.getId
