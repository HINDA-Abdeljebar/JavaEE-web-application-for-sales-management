...
public class CartController extends ActionSupport implements SessionAware {
	...
	private Map<String, Object> session; // autre method pour acceder au session.
	...
	// This method adds selected articles to the session to display them in the cart.
    ...
    // for removing articles from cart
