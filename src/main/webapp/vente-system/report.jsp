...
<body>
  <header>
        ...
        <form id="printButton" action="search" method="get" class="search-form">
  ...
  <br/><br/><br/>
  <h1 style="margin-bottom: 30px;margin-top: 30px;font-family: sans-serif;">Buy operations report :</h1>
  <%  
  ...
  <br>
  <p>
            <span style="font-size: 150%; position: absolute; left: 40%; display: inline; font-weight: bold; font-family: sans-serif; color: red; ;">Total Profit:</span>
            <span style="font-size: 140%;position: absolute; left: 76%; font-family: sans-serif; font-weight: bold;color:green;"><%=total%> $</span>
        </p>
        
        <button id="printButton" style= "margin:10px;"  class="btn btn-success col col-md-1" onclick="window.print()">Print Report</button>


  <br><br>
	
	<a id="printButton" href="#" title="Scroll up" class="up" style="font-size:160%; text-decoration:none;float:right; background-color:red; color:white; border-radius:10px;">^</a>
